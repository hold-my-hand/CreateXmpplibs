...
#if DEBUG
  static const int xmppLogLevel = XMPP_LOG_LEVEL_VERBOSET;
#else
...
{
    NSString *resourceBundle = [[NSBundle mainBundle] pathForResource:@"TransnSDK" ofType:@"bundle"];
    NSBundle *bundle = [NSBundle bundleWithPath:resourceBundle];
    return bundle;
    
//    NSString *bundlePath = [[NSBundle mainBundle] pathForResource:@"TransnSDK.framework/TransnSDK" ofType:@"bundle"];
//    NSBundle *momdBundle = [NSBundle bundleWithPath:bundlePath];
//    return momdBundle;
